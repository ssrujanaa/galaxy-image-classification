...
if [ ! -x Val_Preprocess_py ]; then
    /bin/chmod +x Val_Preprocess_py
fi

printf "\n##################### Checking file integrity for input files #####################\n"  1>&2
# do file integrity checks
pegasus-integrity --print-timings --verify=stdin 1>&2 << 'eof'
Class2_1.jpg:Class3_3.jpg:Class3_1.jpg:Class1_0.jpg:Class4_2.jpg:Val_Preprocess_py:Class0_4.jpg
eof
...
pegasus-kickstart  -n Val_Preprocess.py -N ID0000004 -R condorpool  -s Val_images_Preprocess.npy=Val_images_Preprocess.npy -s Val_labels_Preprocess.npy=Val_labels_Preprocess.npy -L Galaxy -T 2021-04-08T19:14:50+00:00 ./Val_Preprocess_py 
job_ec=$?
